...
<table >
    ...
    <tr><th></th>
        ...
        <a href="<%=ORSView.TIMETABLE_LIST_CTL %>">TimeTable List</b></a> |
         ...
         <a href="<%=ORSView.ORDER_LIST_CTL%>">OrderList</b></a>|
         <a href="<%=ORSView.TOPIC_CTL%>">Add Topic</b></a> |
         <a href="<%=ORSView.TOPIC_LIST_CTL%>">TopicList</b></a>|
          
         <a href="<%=ORSView.HOTEL_CTL%>">Add Hotel</b></a> |
         <a href="<%=ORSView.HOTEL_LIST_CTL%>">HotelList</b></a>|
          <a href="<%=ORSView.BANK_CTL%>">Add Bank</b></a> |
         <a href="<%=ORSView.BANK_LIST_CTL%>">BankList</b></a>|
         <a href="<%=ORSView.LESSION_CTL%>">Add Lession</b></a> |
         <a href="<%=ORSView.LESSION_LIST_CTL%>">LessionList</b></a>|
          
          <a href="<%=ORSView.PRODUCT_CTL%>">Add Product</b></a> |
         <a href="<%=ORSView.PRODUCT_LIST_CTL%>">ProductList</b></a>|
