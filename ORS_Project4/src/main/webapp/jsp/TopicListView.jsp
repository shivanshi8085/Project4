<%@page import="com.rays.pro4.controller.TopicListCtl"%>
<%@page import="com.rays.pro4.Bean.TopicBean"%>
...
<jsp:useBean id="bean" class="com.rays.pro4.Bean.TopicBean" scope="request"></jsp:useBean>
...
<%
				...
				<tr>
					...
					<td align="center"><label>Name</font> :
						...
						value="<%=TopicListCtl.OP_SEARCH%>"> &nbsp; <input
						type="submit" name="operation" value="<%=TopicListCtl.OP_RESET%>">
</td>
</tr>
					...
					<tr>
						<table>
							<td><input type="submit" name="operation"
								value="<%=TopicListCtl.OP_DELETE%>"></td>
							</center>
						</table>
					</tr>
